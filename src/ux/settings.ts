  ...
  await joplin.settings.registerSettings({
    ...
    'model': {
      ...
      options: {
        ...
        'gpt-4o-mini':'OpenAI: gpt-4o-mini (in:128K, out:16K, cheapest)',
        'gpt-4o': 'OpenAI: gpt-4o (in:128K, out:16K, stronger)',
        'o1-preview': 'OpenAI: o1-preview (in:200K, out:100K, reasoning)',
        'gpt-4.5-preview': 'OpenAI: gpt-4.5-preview (in:128K, out:16K, strongest)',
