  ...
  await joplin.settings.registerSettings({
    ...
    'model': {
      ...
      options: {
        ...
        'gpt-4.1': 'OpenAI: gpt-4.1 (in:1M, out:32K, strongest)',
        'o4-mini': 'OpenAI: o4-mini (in:200K, out:100K, reasoning)',
        'o3': 'OpenAI: o3 (in:200K, out:100K, strong reasoning)',
        'claude-3-5-haiku-latest': 'Anthropic: claude-3-5-haiku (in:200K, out:8K, cheapest)',
        'claude-sonnet-4-0': 'Anthropic: claude-4-sonnet (in:200K, out:64K)',
        'claude-opus-4-0': 'Anthropic: claude-4-opus (in:200K, out:32K, strongest)',
        'gemini-2.0-flash-lite': 'Google AI: gemini-2.0-flash-lite (in:1M, out:8K)',
        'gemini-2.5-flash-preview-05-20': 'Google AI: gemini-2.5-flash (in:1M, out:64K)',
        'gemini-2.5-pro-preview-05-06': 'Google AI: gemini-2.5-pro (in:1M, out:64K)',
