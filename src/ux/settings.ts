...
export async function register_settings() {
  ...
  const settings = {
    ...
    'model': {
      ...
      public: true,
      label: 'Chat: Model',
      description: 'The model to ask / chat / research with Jarvis. All predefined models are ONLINE, but custom OFFLINE models are supported. Default: gpt-5.6-luna',
      options: {
        ...
        'gpt-5.6-luna': 'gpt-5.6-luna / OpenAI (in:1M, out:128K, cheapest reasoning)',
        'gpt-5.6-terra': 'gpt-5.6-terra / OpenAI (in:1M, out:128K)',
        'gpt-5.6-sol': 'gpt-5.6-sol / OpenAI (in:1M, out:128K, strongest reasoning)',
        'claude-haiku-4-5': 'claude-haiku-4.5 / Anthropic (in:200K, out:64K, cheapest)',
        'claude-sonnet-5': 'claude-sonnet-5 / Anthropic (in:1M, out:128K)',
        'claude-opus-5': 'claude-opus-5 / Anthropic (in:1M, out:128K, strongest)',
    ...
    'notes_model': {
      ...
      options: {
        ...
        'Universal Sentence Encoder': 'Universal Sentence Encoder (offline) [English]',
        'openai-custom': 'OpenAI-compatible custom model (online/offline)',
        'ollama': 'Ollama (offline)',
        'text-embedding-3-small': 'text-embedding-3-small / OpenAI (online) [Multilingual]',
    ...
    'notes_context_tokens': {
      ...
      description: 'How much note text to send as context. This bounds both the extracts retrieved in "Chat with your notes" and the body of the open note in the chat panel\'s Note mode, where a longer note is cut to fit and Jarvis says so in its answer. Raise it to chat about long notes in full. Default: 2048',
    },
    ...
    'chat_prefix': {
      ...
      section: 'jarvis.chat',
      public: true,
      label: 'Chat: Assistant role label',
    ...
    'chat_suffix': {
      ...
      section: 'jarvis.chat',
      public: true,
      label: 'Chat: User role label',
      description: 'Marks the start of each user turn in a chat note, and is how an existing note is split back into turns. Changing it does not relabel notes you have already written. Default: "\\n\\n---\\n**User:** "',
    },
    'instruction': {
      value: '',
      type: SettingItemType.String,
